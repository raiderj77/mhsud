...
const records: ToolClassificationRecord[] = [
  ...
  original({ route: "/health-recovery-timeline", name: "Health Recovery Timeline Limits", printAvailable: false, scoringSource: "No score is calculated.", scoringCutoffStatus: "Not applicable: this is an information page.", lastVerifiedDate: "2026-09-26", clinicalReviewStatus: "September 26 source-alignment correction; exact medical review remains required and is not newly attributed to Jason Ramirez.", purpose: "Provide general, source-linked recovery education; individual timelines vary and this is not a prognosis.", manualReviewRequired: true }),
  ...
  original({ route: "/withdrawal-timeline", name: "Withdrawal Safety Information", printAvailable: false, scoringSource: "No score is calculated.", scoringCutoffStatus: "Not applicable: this is an information page.", lastVerifiedDate: "2026-09-26", clinicalReviewStatus: "September 26 source-alignment correction; exact medical review remains required and is not newly attributed to Jason Ramirez.", intendedAudience: "Adults seeking general withdrawal-safety education; severe or uncertain symptoms require urgent medical advice.", diagnosticLimits: "General education only. It cannot predict an individual's withdrawal course or make unsupervised withdrawal safe.", manualReviewRequired: true }),
  original({ route: "/treatment-cost-estimator", name: "Treatment Cost Planning", printAvailable: false, scoringSource: "No score is calculated.", scoringCutoffStatus: "Not applicable: this is an information page.", lastVerifiedDate: "2026-09-26", purpose: "Organize provider and insurer questions without generating an unsupported price estimate.", clinicalReviewStatus: "September 26 source-alignment correction; no new professional review is claimed.", diagnosticLimits: "Does not quote prices, determine benefits or recommend a level of care." }),
