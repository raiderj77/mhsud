...
export function SleepMoodClient({ faqData }: Props) {
  ...
  const handleShare = useCallback(async (mode: "share" | "copy") => {
    const outcome = await sharePrivateToolLink({
      ...
      canonicalPath: "/sleep-and-mood-check",
      mode,
    });
    if (outcome === "copied") {
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <header className="mb-8">
        ...
        <p className="text-neutral-500 dark:text-neutral-400 leading-relaxed max-w-xl">
          How is your sleep affecting your mood, energy, and daily life? 10 original questions to help you see the connection, with local browser processing.
        </p>
