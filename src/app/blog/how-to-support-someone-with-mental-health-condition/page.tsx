      ...
      <span>
        ...
        <div className="prose-mh space-y-8">
          ...
          <section>
            ...
            <p>
              The instinct when someone we love is struggling is to fix it. We offer solutions, silver linings, and reassurance. This is well-intentioned, and it often misses the mark.
            </p>
            <p>
              People with mental health conditions have usually already tried the obvious things. They know exercise helps depression; they&rsquo;ve been told to think positive. What they often need first is not a solution, it&rsquo;s acknowledgment that what they&rsquo;re experiencing is real, hard, and understandable.
            </p>
            <p>
              The single most common support mistake is <strong>jumping to problem-solving before validation</strong>. A person who shares that they&rsquo;re struggling with anxiety and is immediately met with &ldquo;have you tried meditation?&rdquo; often feels more alone, not less, as though their experience is a simple problem with an obvious solution they&rsquo;ve failed to implement.
            </p>
          ...
          <section>
            ...
            <p>
              Validation is communicating that you understand why the person feels the way they do, not that you agree with every thought or that the situation is objectively as bad as it feels, but that the emotional experience makes sense given their context.
            </p>
            <p><strong>Validating responses:</strong></p>
            <ul className="list-disc pl-5 space-y-2">
              <li>&ldquo;That sounds really hard.&rdquo;</li>
              <li>&ldquo;I can understand why you&rsquo;re feeling overwhelmed, that&rsquo;s a lot.&rdquo;</li>
          ...
          <section>
            ...
            <p>
              <strong>&ldquo;You don&rsquo;t have to explain anything, I just wanted you to know I&rsquo;m thinking about you.&rdquo;</strong> Removes the pressure to perform or articulate suffering clearly.
            </p>
            <p>
            ...
            <p>
              <strong>&ldquo;I know exactly how you feel.&rdquo;</strong> You don&rsquo;t, and claiming you do often shuts conversation down.
            </p>
            <p>
            ...
            <p>
              <strong>&ldquo;Everyone feels like that sometimes.&rdquo;</strong> True, but minimizing, what the person is experiencing may be qualitatively different from ordinary sadness or stress.
            </p>
            <p>
              <strong>&ldquo;Have you thought about seeing someone?&rdquo;</strong> This can be useful, once, gently. Repeating it when the person isn&rsquo;t ready often feels like pressure to fix themselves for your comfort.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Enabling</strong> means doing things that allow the person to avoid addressing the condition, accommodating avoidance patterns, covering for consequences, or taking over responsibilities in ways that prevent the person from engaging with their own life and treatment.
            </p>
            ...
            <p>
              There are no universal answers to these questions. A therapist or counselor, including family-focused resources like CRAFT (Community Reinforcement and Family Training), can help navigate the specifics of your situation.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Offer specific help.</strong> &ldquo;Would it help if I helped you look up therapists?&rdquo; or &ldquo;I could go with you to the first appointment if that would make it easier&rdquo;, specific offers reduce friction more than general encouragement.
            </p>
            <p>
            ...
            <p>
              <strong>Share resources without pressure.</strong> &ldquo;I came across this screening tool, it only takes two minutes if you&rsquo;re ever curious where things stand&rdquo; is different from &ldquo;you need to take this test.&rdquo;
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              A mental health crisis, involving thoughts of suicide or self-harm, severe dissociation, psychosis, or inability to care for oneself, requires a different approach.
            </p>
            <p><strong>What to do:</strong></p>
            <ul className="list-disc pl-5 space-y-2">
              <li>Stay calm. Your calm is regulated, it communicates safety.</li>
              <li>Ask directly: &ldquo;Are you thinking about hurting yourself?&rdquo; Research consistently shows that asking about suicide does not plant the idea, it opens the door.</li>
            ...
            <p>
              <strong>After the crisis:</strong> Follow up. Show up. The period after a mental health crisis is high-risk, connection and ongoing support matter enormously.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Supporting someone with a mental health condition is not emotionally neutral. Compassion fatigue, the depletion that comes from sustained emotional caregiving, is real.
            </p>
            ...
            <p>
              Your own wellbeing is not a luxury or a betrayal of the person you&rsquo;re supporting, it is a prerequisite for sustained support. You cannot pour from an empty cup, and unsustainable support often leads to abrupt withdrawal that harms both parties.
            </p>
            <p>Concrete steps:</p>
            <ul className="list-disc pl-5 space-y-2">
              <li>Maintain your own support network, don&rsquo;t let your social life shrink to the person you&rsquo;re supporting</li>
              <li>Set limits on what you can offer (&ldquo;I can talk for an hour but I need to sleep after that&rdquo;)</li>
              <li>Consider your own therapy, supporting someone with a mental health condition is a legitimate reason to seek professional support yourself</li>
          ...
          <section>
            ...
            <p>
              <strong>Supporting someone with depression:</strong> The withdrawal, reduced communication, and cancelled plans of depression are not rejection, but they can feel that way. Consistent, low-pressure contact (&ldquo;just wanted to say I&rsquo;m thinking about you, no need to reply&rdquo;) matters more than big gestures. Help with practical tasks without taking over; depression makes everything harder.
            </p>
            <p>
              <strong>Supporting someone with anxiety:</strong> Avoid accommodating avoidance, it maintains anxiety long-term. Gentle encouragement toward rather than away from feared situations is kinder in the long run than permanent accommodation. Don&rsquo;t provide excessive reassurance; it functions like a compulsion for anxiety.
            </p>
            <p>
              <strong>Supporting someone with PTSD:</strong> Trauma responses, startle, dissociation, avoidance, emotional numbness, make sense as responses to what happened. Don&rsquo;t push for disclosure before the person is ready. Learn their triggers if they share them. Don&rsquo;t interpret PTSD symptoms as personal rejection.
            </p>
            <p>
          ...
          <div className="rounded-lg bg-sage-50 dark:bg-sage-950/30 border border-sage-200 dark:border-sage-800 p-6 text-center">
            ...
            <p className="text-sm text-sage-700 dark:text-sage-400 mb-4">
              Share these free, confidential screening tools with someone you care about, no account needed.
            </p>
