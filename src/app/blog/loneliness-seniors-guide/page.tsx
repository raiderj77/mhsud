      ...
      <span>
        ...
        <div className="prose-mh space-y-8">
          ...
          <section>
            ...
            <ul>
              <li><strong>29% increased risk of heart disease</strong>, chronic loneliness activates stress responses that elevate blood pressure, cortisol, and systemic inflammation</li>
              <li><strong>32% increased risk of stroke</strong>, the inflammatory and cardiovascular effects compound over time</li>
              <li><strong>50% increased risk of dementia</strong>, social engagement is one of the strongest protective factors for cognitive function, and its absence accelerates decline</li>
              <li><strong>26% increased risk of premature death</strong>, the mortality risk is comparable to smoking 15 cigarettes daily and exceeds the risk from obesity</li>
            </ul>
            <p>
          ...
          <section>
            ...
            <ul>
              <li><strong>Social isolation</strong> is objective, it describes having limited social contacts, living alone, or lacking participation in social activities. It can be measured by counting interactions, group memberships, and household composition</li>
              <li><strong>Loneliness</strong> is subjective, it is the distressing feeling that arises from the gap between the social connection you want and what you actually have. It is an emotional experience, not a circumstance</li>
            </ul>
            <p>
          ...
          <section>
            ...
            <ul>
              ...
              <li><strong>Lack of transportation:</strong> Losing the ability to drive, or never having driven, creates dependence on others for every social interaction outside the home</li>
          ...
          <section>
            ...
            <ul>
              ...
              <li><strong>Structured social activities:</strong> Senior centers, faith communities, volunteer programs, and group classes provide regular, predictable social contact. The key is consistency, one-time events are less effective than recurring activities that allow relationships to develop</li>
              ...
              <li><strong>Intergenerational programs:</strong> Programs that connect older adults with younger people, through tutoring, mentoring, or shared activities, provide mutual benefit and meaningful social roles</li>
          ...
          <section>
            ...
            <ul>
              <li>Visit regularly and predictably, consistency matters more than duration</li>
              ...
              <li>Address hearing and vision problems, getting hearing aids or updated glasses can dramatically improve social engagement</li>
              <li>Watch for signs of depression alongside loneliness, withdrawal, changes in appetite, sleep disruption, loss of interest in previously enjoyed activities</li>
          ...
          <section>
            ...
            <ul>
              ...
              <li>Signs of depression accompany the loneliness, changes in sleep, appetite, energy, or interest in activities</li>
              <li>The person has stopped activities they previously enjoyed</li>
              <li>Self-care is declining, hygiene, nutrition, medication management, home maintenance</li>
              <li>Cognitive changes are noticeable, confusion, memory problems, difficulty following conversations</li>
