...
const FAQ_DATA = [
  ...
  { question: "What is the difference between DBT and CBT?", answer: "Cognitive behavioral therapy (CBT) focuses primarily on identifying and changing unhelpful thought patterns and behaviors. DBT includes cognitive-behavioral techniques but adds two critical elements: acceptance-based strategies drawn from mindfulness and Zen practice, and a strong emphasis on building concrete skills for managing intense emotions and interpersonal conflict. CBT tends to focus on change; DBT balances change with acceptance. DBT also includes skills training as a core component, which is not standard in traditional CBT." },
  { question: "Can I learn DBT on my own?", answer: "You can learn and practice individual DBT skills on your own using books, workbooks, and online resources. Many people find significant benefit from self-guided practice. However, comprehensive DBT — the full treatment model — includes individual therapy, a skills training group, phone coaching, and a therapist consultation team. The full model is most effective for complex or severe difficulties. For everyday emotional challenges, self-guided skill practice may be a helpful starting point." },
  { question: "What does TIPP stand for in DBT?", answer: "TIPP is a distress tolerance acronym that stands for Temperature (using cold water or ice to activate the dive reflex and calm your nervous system), Intense exercise (burning off stress hormones through vigorous physical activity), Paced breathing (slowing your exhale to activate the parasympathetic nervous system), and Progressive muscle relaxation (systematically tensing and releasing muscle groups to reduce physical tension). TIPP skills are designed for moments of acute crisis when emotions feel overwhelming." },
  { question: "How long does DBT take to work?", answer: "A standard comprehensive DBT program typically runs for about one year, with weekly individual therapy sessions and weekly skills group sessions. Many people begin noticing improvements in their ability to manage emotions and tolerate distress within the first few months of consistent practice. However, building lasting habits takes time. Self-guided skill practice does not follow a fixed timeline — you may notice benefits as soon as you begin applying skills consistently to real-life situations." },
];
