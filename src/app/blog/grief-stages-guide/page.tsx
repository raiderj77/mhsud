...
const FAQ_DATA = [
  { question: "Is there a right way to grieve?", answer: "There is no single right way to grieve. Grief is shaped by your relationship with the deceased, cultural background, support system, and temperament. Research shows grief does not follow a predictable sequence. The key concern is not how you grieve, but whether grief prevents daily functioning for an extended period." },
  { question: "How long does grief normally last?", answer: "There is no fixed timeline. Most people experience gradual reduction in acute grief over 6 to 12 months, but waves can resurface for years around anniversaries and reminders. If intense symptoms persist at the same intensity for 12 months or more and impair functioning, this may indicate prolonged grief disorder." },
  { question: "What is prolonged grief disorder?", answer: "Prolonged grief disorder (PGD) is recognized in the DSM-5-TR and ICD-11. It involves persistent, intense grief that impairs daily functioning beyond cultural norms. Key features include intense yearning, identity disruption, emotional numbness, and avoidance of reminders. Approximately 7\u201310% of bereaved individuals develop PGD. Effective treatments exist." },
  { question: "When should I see a therapist for grief?", answer: "Consider professional support if grief stays at the same intensity for many months, you cannot perform daily tasks, you feel persistent hopelessness, you are using substances to cope, or you are having thoughts of self-harm. You do not need a clinical diagnosis to benefit from grief counseling." },
];
