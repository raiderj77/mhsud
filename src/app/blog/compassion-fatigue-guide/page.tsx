...
const FAQ_DATA = [
  { question: "What is the difference between compassion fatigue and burnout?", answer: "Burnout is driven by workload, organizational stress, and feeling overextended. Compassion fatigue is specifically caused by the emotional weight of caring for people who are suffering. A burned-out accountant is exhausted by deadlines and bureaucracy; a compassion-fatigued nurse is exhausted by absorbing patients\u2019 pain. In practice, the two often co-occur \u2014 but the distinction matters because the interventions differ. Burnout responds to workload changes; compassion fatigue requires emotional processing, boundary work, and sometimes clinical support." },
  { question: "Who is most at risk for compassion fatigue?", answer: "Anyone who regularly witnesses or absorbs the suffering of others is at risk. This includes nurses, social workers, therapists, counselors, EMTs and first responders, hospice workers, veterinarians, teachers in high-need settings, and family caregivers of people with chronic illness or disability. Research consistently shows that higher empathy, less experience, a personal trauma history, and limited organizational support all increase vulnerability." },
  { question: "Can compassion fatigue be prevented?", answer: "It can be significantly reduced, though anyone in a caregiving role carries some risk. Evidence-based prevention strategies include regular self-assessment (using tools like the ProQOL), clinical supervision or peer support, firm boundaries between work and personal life, mindfulness and stress-reduction practices, balanced caseloads, and taking time off before exhaustion forces it. Organizations also play a critical role by normalizing mental health support, providing supervision, and monitoring workloads." },
  { question: "How do I know if I have compassion fatigue?", answer: "Common signs include emotional exhaustion that feels tied to the suffering of those you care for, reduced empathy or feeling numb toward clients or patients, intrusive thoughts about their cases, difficulty separating work from personal life, hypervigilance, sleep disturbances, and a growing sense that you cannot make a difference. Physical symptoms like chronic fatigue, headaches, and frequent illness are also common. A validated self-assessment like the ProQOL can help you reflect on these patterns \u2014 but only a mental health professional can evaluate your specific situation." },
];
