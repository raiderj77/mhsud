...
export default function DepressionScreeningForMenPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(toolPageJsonLd({ name: "Depression Screening for Men — PHQ-9", description: "A free, private depression screening tool for men using the clinically validated PHQ-9.", url: TOOL_URL, datePublished: "2026-03-10", dateModified: new Date().toISOString().substring(0,10) })) }} />
