...
const FAQ_DATA = [
  ...
  { question: "How do I calculate standard drinks?", answer: "The formula is: (volume in ounces) \u00d7 (alcohol percentage as decimal) \u00d7 (29.5735 mL per oz) \u00d7 (0.789 g/mL density of alcohol) \u00f7 14 grams. A simpler approximation: multiply the volume in US fluid ounces by the ABV expressed as a decimal, then divide by 0.6. For example, a 16 oz beer at 6%: 16 \u00d7 0.06 = 0.96 oz of pure alcohol, divided by 0.6 = 1.6 standard drinks. This calculator does the math for you." },
...
<StandardDrinksClient faqData={FAQ_DATA} />
      <p className="max-w-2xl mx-auto px-4 pb-8 text-sm">Definition source: <a className="underline" href="https://www.niaaa.nih.gov/alcohols-effects-health/what-standard-drink" rel="noreferrer">NIAAA: a U.S. standard drink</a>. Formula wording checked September 26, 2026; this is not a new clinical review. Use the alcohol percentage as a decimal: 6% = 0.06. This count does not establish safety to drive, a diagnosis or an individually safe amount.</p>
    </>
  );
}
