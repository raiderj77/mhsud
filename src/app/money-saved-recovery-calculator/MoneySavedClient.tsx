...
export function MoneySavedClient({ faqData }: Props) {
  ...
  const handleShare = useCallback(async (mode: "share" | "copy") => {
    const outcome = await sharePrivateToolLink({
      ...
      canonicalPath: "/money-saved-recovery-calculator",
      mode,
    });
    if (outcome === "copied") {
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <header className="mb-8">
        ...
        <p className="text-neutral-500 dark:text-neutral-400 leading-relaxed max-w-xl">
          See the financial impact of your recovery. Enter your substance, what you used to spend, and how long you&apos;ve been sober. Entries and calculations are processed locally and are not intentionally sent to MindCheck Tools. Copies, sync, and shared-device access are outside this boundary.
        </p>
