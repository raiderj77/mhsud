    ...
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10" aria-live="polite">
        ...
        <div className="mb-6 p-4 bg-sand-100 dark:bg-night-800 border border-sand-200 dark:border-neutral-700 rounded-xl text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <p>
            The Athens Insomnia Scale is a screening tool for educational and self-reflection purposes. It is not a clinical assessment and cannot determine whether you have a sleep disorder. A score of 6 or higher suggests insomnia that may warrant professional evaluation. This tool does not screen for sleep apnea, restless leg syndrome, or other medical sleep conditions. Always consult a qualified healthcare professional for persistent sleep difficulties. Reviewed by Jason Ramirez, CADC-II, Certified Drug and Alcohol Counselor with 11 years of clinical experience.
          </p>
        </div>
