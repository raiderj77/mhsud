          ...
          <div className="space-y-3">
            {QUESTIONS.map((q, qi) => {
              ...
              return (
                <div key={qi}>
                  {showDomainLabel && (
                    <div className="text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wide mt-4 mb-2">{q.domain}</div>
                  )}
      ...
      {showResults && (
        <div ref={resultsRef} className="animate-fade-in" aria-live="polite">
          ...
          <footer className="border-t border-sand-200 dark:border-neutral-700 pt-6 text-center">
            <p className="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">This is an original tool created by MindCheck Tools. It is not based on any proprietary or copyrighted scale.</p>
            <p className="text-xs text-neutral-500 dark:text-neutral-400">For personal reflection only. Not medical advice, a diagnosis, or a treatment recommendation.</p>
            <ToolReviewerBio />
          </footer>
        </div>
      )}
