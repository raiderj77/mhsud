...
export const metadata: Metadata = createMetadata({
  ...
  title: "Bipolar Screening for Young Adults — Under Licensing Review",
  description:
    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        <h1 className="text-3xl font-bold text-warm-900 dark:text-warm-100 mb-6 text-center">
          Bipolar Screening for Young Adults — Under Licensing Review
        </h1>

        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-8">
          <p className="text-warm-700 dark:text-warm-300 leading-relaxed">
            This page used the Mood Disorder Questionnaire (MDQ), a copyrighted bipolar screening instrument. We are pursuing written commercial-use clearance from the rights holder before continuing to publish this tool. In the meantime, if you are a young adult experiencing mood symptoms that concern you, please speak with a licensed clinician. The DASS-21 is available as a related screening tool covering depression, anxiety, and stress.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <Link href="/phq-9-depression-test" className="block border border-warm-200 dark:border-warm-700 rounded-xl p-4 hover:border-sage-300 dark:hover:border-sage-700 transition-colors">
            <p className="text-sm font-semibold text-sage-600 dark:text-sage-400 mb-1">PHQ-9 Depression Test</p>
            <p className="text-xs text-warm-500 dark:text-warm-400">Validated depression screening</p>
          </Link>
