      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {[
            ...
            <Link key={post.slug} href={`/blog/${post.slug}`} className="card p-5 group hover:border-sage-300 dark:hover:border-sage-700 transition-colors">
              ...
              <span className="inline-block mt-3 text-xs text-sage-600 dark:text-sage-400 font-medium">Read guide →</span>
            </Link>
          ))}
        </div>
      </section>
