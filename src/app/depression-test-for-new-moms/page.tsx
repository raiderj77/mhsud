  ...
  return (
    <>
      ...
      ...medicalWebPageJsonLd({
              name: "Postpartum Depression Screening for New Mothers",
              description: "Free PHQ-9 depression screening for new mothers with clinical context on postpartum depression, baby blues, and evidence-based treatment options.",
              url: TOOL_URL,
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12">
        ...
        <div className="mb-10">
          ...
          <div className="space-y-4 text-slate-700 dark:text-slate-300">
            ...
            <p>
              <strong>Irritability and anger:</strong> Some women experience PPD as rage, disproportionate anger at partners, older children, or themselves. This presentation is
...
<PHQ9Client faqData={FAQ_DATA} />
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-10">
        ...
        <div className="mb-6"><p className="text-sm text-slate-500 dark:text-slate-400 italic">This screening tool is for educational purposes only, it is not a diagnosis. Only a qualified healthcare professional can diagnose postpartum depression. Questionnaire answers and scores are processed locally and are not intentionally sent to MindCheck Tools.</p></div>
