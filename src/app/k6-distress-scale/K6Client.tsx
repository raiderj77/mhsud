  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="mb-6 p-4 bg-sand-100 dark:bg-night-800 border border-sand-200 dark:border-neutral-700 rounded-xl text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">
        <p className="font-semibold mb-1">Clinical Disclaimer</p>
        <p>
          The K6 is a screening tool for educational and self-reflection purposes. It is not a clinical assessment and cannot determine whether you have a specific mental health condition. A score of 13 or higher suggests serious psychological distress that may warrant professional evaluation. Always consult a qualified healthcare professional for mental health concerns. Reviewed by Jason Ramirez, Certified Drug and Alcohol Counselor (CADC-II).
        </p>
      </div>
