...
export default function DepressionTestForSeniorsPage() {
  return (
    <>
      ...
      ...toolPageJsonLd({ name: "Depression Test for Seniors, PHQ-9 Screening", description: "A free, private depression screening tool for older adults using the PHQ-9.", url: TOOL_URL, datePublished: "2026-03-05", dateModified: "2026-05-08" }),
      ...
      ...medicalWebPageJsonLd({
              name: "Depression Screening for Older Adults",
              description: "Free PHQ-9 depression screening for adults 65 and older, with clinical context on late-life depression, vascular depression, and grief.",
              url: TOOL_URL,
        ...
        <div className="mb-10">
          ...
          <div className="space-y-4 text-slate-700 dark:text-slate-300">
            <p>
              ...
              connection, a sense of purpose, and a clear role in the world. When that disappears, sometimes abruptly, the void can be disorienting. Studies show that depression
        ...
        <div className="mb-10">
          ...
          <div className="space-y-4 text-slate-700 dark:text-slate-300">
            ...
            <p>
              ...
              it may have evolved into prolonged grief disorder, major depression, or both, conditions that benefit from targeted professional support.
            </p>
          </div>
        </div>
      </div>
