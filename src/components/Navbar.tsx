...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { href: "/health-recovery-timeline", label: "Health Timeline", sub: "Recovery timeline limits" },
      ...
      { href: "/withdrawal-timeline", label: "Withdrawal Safety", sub: "Sources and support" },
      { href: "/treatment-cost-estimator", label: "Treatment Costs", sub: "Plan provider questions" },
