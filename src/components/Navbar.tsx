        ...
        >
          <div className="max-w-6xl mx-auto px-6 py-5">
            ...
            <div className="max-h-[60vh] overflow-y-auto pr-1 -mr-1">
              {filtered.length === 0 ? (
                <p className="text-sm text-neutral-400 dark:text-neutral-500 py-8 text-center">No tools match your search.</p>
              ) : activeCategory === "all" && !search.trim() ? (
                /* Grouped view when "All" and no search */
                <div className="space-y-5">
                  {CATEGORIES.map((cat) => (
                    <div key={cat.id}>
                      <h3 className="text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-2 flex items-center gap-2">
                        ...
                        {cat.tools.map((tool) => (
                          ...
                          >
                            <div>
                              ...
                              <p className="text-xs text-neutral-400 dark:text-neutral-500">{tool.sub}</p>
                            </div>
                          </Link>
                        ))}
                      </div>
            ...
            <div key={cat.id}>
              ...
              >
                <span className="flex items-center gap-2.5">
                  ...
                  {cat.name}
                  <span className="text-xs font-normal text-neutral-400 dark:text-neutral-500">({cat.tools.length})</span>
                </span>
                <svg
