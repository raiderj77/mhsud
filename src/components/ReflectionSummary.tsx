  ...
  return (
    <div className="mb-5">
      <p className="sr-only" role="status" aria-live="polite">
        {status === "generating" ? "Generating your reflection summary." : status === "done" ? "Reflection summary downloaded." : ""}
      </p>
      <button
        type="button"
      ...
      >
        {status === "generating" ? (
          ...
          <>
            <svg className="w-4 h-4 text-sage-600 dark:text-sage-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
